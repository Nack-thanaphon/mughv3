                    ...
                    <div class="col-12 col-sm-4 m-0 pt-2 p-sm-0 p-0">
                        <div class="row m-0 p-0  text-start text-sm-end">
                            <div class="col-12 col-sm-10 text-sm-end m-0 p-0">
                                <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" class="text-decoration-none text-danger"><i class="fa-sharp fa-solid fa-images "></i> SeeMorePictures (<?= count($row['image']) ?>)</a>
                            </div>
