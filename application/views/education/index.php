...
<div class="row m-0 p-0">
    <div class="col-12 py-5 bg-primary text-center">
        <h1 class="p-0 m-0 text-white text-center ">EDUCATION
        </h1>
    </div>
    <div class="col-12 p-5">
        <div class="row m-0 p-0">
            <div class="col-12 col-sm-6 my-1">
                <div class="card mx-auto  bg-primary shadow-sm h-100">
                    <a href="<?= site_url('Education/ourProgram') ?>" class="text-decoration-none">
                        <div class="card-body p-5">
                            <h4 class="text-white text-center p-0 m-0 ">Global Health Program</h4>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-12 col-sm-6 my-1">
                <div class="card mx-auto  bg-primary shadow-sm h-100">
                    <div class="card-body p-5">
                        <h4 class="text-white text-center p-0 m-0 ">Courses</h4>
                    </div>
                </div>
            </div>
